...
public:
    ...
    ///DigiCut boolean varibles
    bool DigiCutT1, DigiCutT2, DigiCut;
    ...
    GleamDigiTstop;
     ...
     /// Tstart of the Run forced from the command line
    double DigiCutTstart,
            /// Tstop of the Run forced from the command line
            DigiCutTstop;
