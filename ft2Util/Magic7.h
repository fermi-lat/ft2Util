...
class Magic7 {
  ...
  */
  ...
  /**
  *@brief Get the best estimate of the velocity of the satellite at a certain time
  @param time The time of interest
  If a ORB message correspond exactly to "time", the velocity contained there is returned. Otherwise, a interpolation/
  extrapolation is performed.
  */
  const CLHEP::Hep3Vector getVelocity(double time) const;
  /**
